...
export default [
  {
    ...
    description:
      'This data required that I collect the link of each song and run a count on how many songs came from each source. As the results show, Genius and AzLyrics are the most effective for scraping lyrics. ',
    options: {
      chart: {
        spacingBottom: 0,
        spacingTop: 0,
